...
<div class="container">
	<div id="project{{$i}}" class="projects">
		<div class="projects-projectname">Project Name</div>
		<div class="project">
			<div class="row">
				<div class="col-sm-4">
				...
				<div class="col-sm-3">
					...
					<div class="row project--po">
						<h4>Product Owner</h4>
						<div class="projects--po-image">
							<div class="col-xs-4">
								<img src="http://placehold.it/80x80" alt="product owner">
							</div>
							<div class="col-xs-8">
								<h5 class="projects-po--name">Firstname Lastname</h5>	
						
								<div class="projects-po--title">Staff</div>
							</div>
						</div>
